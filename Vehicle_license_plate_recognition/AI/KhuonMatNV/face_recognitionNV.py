...
frame_size = (640, 480)
IMG_PATH = './/KhuonMatNV/data/test_images'
DATA_PATH = './/KhuonMatNV/data'
power = pow(10, 6)
...
def inference(device, model, face, local_embeds, threshold=3):
...
def recognitionNV(image):
    ...
    if boxes is not None:
        for box in boxes:
            ...
            idx, score = inference(device, model, face, embeddings)
            if idx != -1:
