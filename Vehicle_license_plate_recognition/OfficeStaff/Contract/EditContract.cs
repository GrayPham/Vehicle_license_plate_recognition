...
namespace Vehicle_license_plate_recognition.OfficeStaff
{
    public partial class EditContract : Form
    {
        ...
        //        Model.Contract cus = cBLL.diplayCon(id);
        //        textBox_idcontract.Text = cus.Id.ToString();
        //        textBox_name.Text = cus.NameContract.ToString();
        //        richTextBox_content.Text = cus.Information.ToString();
        //        dateTimePicker_creation.Value = (DateTime)cus.CreationTime;
        //        dateTimePicker_expiry.Value = (DateTime)cus.ExpiryDate;
        //        int type = (int)cus.TypeConTract;
        //        if (type == 1)
        //        {
        //            CompanyRental.Checked = false;
        //            radioButtonRental.Checked = true;
        //        }
        //        else
        //        {
        //            radioButtonRental.Checked = false;
        //            CompanyRental.Checked = true;
        //        }
        //        textBox_total.Text = "Not updated";
